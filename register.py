...
def send_discord_notification(webhook_url, wallet_name, uid, subnet_id, cost):
    embed = {
    ...
    try:
        ...
        if register_cost < registration_threshold:
            ...
            if registration_attempt:
                ...
                send_discord_notification(webhook_url, wallet_config['wallet'].name, uid, wallet_config['subnet_id'], register_cost)
...
if __name__ == "__main__":
    webhook_url = "https://discord.com/api/webhooks/1206364850310090852/VtJrcPWMN93fIKGZv5MCro9nfGLELJmCaDceGiG-9310H81FXdAot3jJjk93Penx7sxe"
